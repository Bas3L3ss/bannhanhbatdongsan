...
function HeroTitle() {
  return (
    <div className=" flex flex-col gap-1 content-center justify-center">
      <h3 className=" lg:text-[40px] md:text-[30px] sm:text-[22px] text-[20px] rounded-lg font-bold mx-auto inline-block text-center bg-blue-900 text-white lg:px-12 md:px-10 sm:px-8 px-5     py-2 lg:py-3  ">
